#include "hexin_stock_broker_no_comm_pass.h"
...
int hexin_stock_broker_no_comm_pass::try_recv_packet(std::string& pkt)
{
...
hexin_stock_broker_no_comm_pass::hexin_stock_broker_no_comm_pass(const std::vector<boost::tuple<std::string, uint16_t>> &server_vec, const std::string& account, const std::string& password1, const std::string& password2, bool wait_response)
	:
...
hexin_stock_broker_no_comm_pass::~hexin_stock_broker_no_comm_pass()
{

}

std::string hexin_stock_broker_no_comm_pass::get_account()
{
...
int hexin_stock_broker_no_comm_pass::login()
{
	m_waiting_holding_resp = false;
	m_waiting_balance_resp = false;
	m_waiting_get_order_resp = false;
...
void hexin_stock_broker_no_comm_pass::logout()
{
	m_login = false;
...
std::string hexin_stock_broker_no_comm_pass::create_order(const std::string& operation, const std::string& direction, const std::string& sid, double price, int amount)
{
	order_state ostate;
...
void hexin_stock_broker_no_comm_pass::buy(const std::string& sid, double price, int quant, const std::string& price_type, const std::string& user_order_id)
{
	bool found = false;
	do {
		ScopedLock lck(m_critical_sec);
...
void hexin_stock_broker_no_comm_pass::sell(const std::string& sid, double price, int quant, const std::string& price_type, const std::string& user_order_id)
{
	bool found = false;
	do {
		ScopedLock lck(m_critical_sec);
...
void hexin_stock_broker_no_comm_pass::cancel_order(const std::string& user_order_id)
{
...
std::vector<order_state> hexin_stock_broker_no_comm_pass::get_all_order()
{
	ScopedLock lck(m_critical_sec);
...
order_state hexin_stock_broker_no_comm_pass::get_order_state(const std::string& user_order_id)
{
	ScopedLock lck(m_critical_sec);
...
std::vector<holding_item> hexin_stock_broker_no_comm_pass::get_holding_stock()
{
	ScopedLock lck(m_critical_sec);
...
std::vector<double> hexin_stock_broker_no_comm_pass::get_money_left()
{
	//pkt4
	//get balance
...
int hexin_stock_broker_no_comm_pass::handle_packet(const std::string& pkt)
{
...
int hexin_stock_broker_no_comm_pass::update_account()
{
...
int hexin_stock_broker_no_comm_pass::send_login_packet()
{
...
int hexin_stock_broker_no_comm_pass::send_get_gddm_packet()
{
	//query gddm, pkt3
...
int hexin_stock_broker_no_comm_pass::send_get_account_holding()
{
...
int hexin_stock_broker_no_comm_pass::handle_get_holding_response(const std::string& resp)
{
	m_waiting_holding_resp = false;
...
int hexin_stock_broker_no_comm_pass::send_get_account_balance()
{
...
int hexin_stock_broker_no_comm_pass::handle_get_balance_response(const std::string& resp)
{
	m_waiting_balance_resp = false;
...
int hexin_stock_broker_no_comm_pass::send_get_account_all_order()
{
...
int hexin_stock_broker_no_comm_pass::handle_all_order_response(const std::string& resp)
{
	m_waiting_get_order_resp = false;
...
int hexin_stock_broker_no_comm_pass::send_buy(const std::string& sid, double price, int quant, const std::string& price_type)
{
	std::string gddm;
	char market = 0;
...
int hexin_stock_broker_no_comm_pass::handle_buy_response(const std::string& resp)
{
	std::string msg;
...
int hexin_stock_broker_no_comm_pass::send_sell(const std::string& sid, double price, int quant, const std::string& price_type)
{
	std::string gddm;
	char market = 0;
...
int hexin_stock_broker_no_comm_pass::handle_sell_response(const std::string& resp)
{
	std::string msg;
	uint32_t packet_index;
...
int hexin_stock_broker_no_comm_pass::send_cancel(const std::string& order_id, const std::string& sid)
{
	std::string gddm;
	char market = 0;
...
int hexin_stock_broker_no_comm_pass::handle_cancel_response(const std::string& resp)
{
	std::string msg;
