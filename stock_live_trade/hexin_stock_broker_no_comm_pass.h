...
class hexin_stock_broker_no_comm_pass : public stock_broker
{
public:
	hexin_stock_broker_no_comm_pass(const std::vector<boost::tuple<std::string, uint16_t>> &server_vec, const std::string& account, const std::string& password1, const std::string& password2, bool wait_response = true);
	virtual ~hexin_stock_broker_no_comm_pass();
